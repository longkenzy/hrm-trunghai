...
CREATE TABLE IF NOT EXISTS employee_salaries_banks (
    ...
    insurance_salary DECIMAL(15, 2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS employee_insurance_welfare (
    ...
    total_insurance_rate DECIMAL(6, 4) DEFAULT 0,
    social_insurance_rate DECIMAL(6, 2) DEFAULT 0,
    health_insurance_rate DECIMAL(6, 2) DEFAULT 0,
    unemployment_insurance_rate DECIMAL(6, 2) DEFAULT 0,
